...
<section class="products iconic-products">
  <?php
  // Fetch iconic jerseys from database (category contains 'iconic' or 'classic')
  $sql = "SELECT * FROM products WHERE category LIKE '%iconic%' OR category LIKE '%classic%' OR era IS NOT NULL ORDER BY era DESC";

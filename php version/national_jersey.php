...
<section class="products nation-products">
  <?php
  // Fetch national team jerseys from database
  $sql = "SELECT * FROM products WHERE category LIKE '%national%' OR category LIKE '%country%' OR team IN ('Brazil', 'France', 'Germany', 'Argentina', 'Spain', 'England', 'Portugal', 'Netherlands', 'Italy', 'Belgium') ORDER BY team";

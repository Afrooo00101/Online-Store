...
<section class="products special-products">
  <?php
  // Fetch special edition products from database
  $sql = "SELECT * FROM products WHERE category LIKE '%special%' OR category LIKE '%premium%' OR category LIKE '%exclusive%' ORDER BY price DESC";
